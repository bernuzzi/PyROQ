...
# TEOBSPA-NRPMw with PM recalibrations
# --------
try:

    # NRPMw imports
    # Note: the NRPMw_attach method does not include merger/fusion wavelet
    from bajes.obs.gw.approx.teobresums import teobresums_spa_nrpmw_recal_wrapper
    from bajes.obs.gw.approx.nrpmw import __recalib_names_attach__ as recalib_names
...
#            p['q']      = q
            ...
            for ni in recalib_names:
                p['NRPMw_recal_'+ni] = p['nrpmw-{}'.format(ni)]
